...
<img src="images/mtsicon.jpg" width="50" height="50"> Evaluasi Raport Siswa
</h1>
<ol class="breadcrumb">
<li>
...
<li class="active">
<i class="fa fa-table"></i>Data Raport
</li>
</ol>
...
<td><center>Lihat Hasil Raport Siswa</center></td>
</tr>
</thead>
<?php
...
<td><center>
<a href='nilai_detailraport_admin.php?id=".$hasil['nis']."' class='btn btn-info'><img src='images/detail.png' width='20' height='20'></a>
</tr>";
}
?>
</table>
